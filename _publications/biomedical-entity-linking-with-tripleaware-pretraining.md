...
{% raw %}
```bibtex
@inproceedings{DBLP:conf/semtech4stld/YanMU25,
  author       = {Xi Yan and
                  Cedric M{\"{o}}ller and
                  Ricardo Usbeck},
