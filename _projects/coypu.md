...
date: 2021-06-01 # Format exactly like this: YYYY-MM-DD. This controls the sorting order (newest first)
end_date: 2024-05-01 
status: "Completed" # e.g. "Ongoing", "Completed", "In Review"
thumbnail: "/assets/icons/coypu-logo.png" # Square preview image for the main Projects list
...
<figure style="text-align: center; margin: 2rem 0;">
  ...
  <figcaption style="font-size: 0.9rem; color: gray; margin-top: 0.5rem;"></figcaption>
</figure>
...
<figure style="text-align: left; margin: 2rem 0;">
  <img src="{{ '/assets/icons/bmwk-foerderlogo.png' | relative_url }}" alt="Description" style="width: 100%; max-width: 300px; height: auto; border-radius: 8px; box-shadow: 0 4px 4px rgba(0,0,0,0.1);">
  <figcaption style="font-size: 0.9rem; color: gray; margin-top: 0.5rem;"></figcaption>
</figure>
